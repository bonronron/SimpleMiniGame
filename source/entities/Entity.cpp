...
Entity::Entity() :
	// <FEEDBACK> Delete all code (in your submission, not just this constructor) that is commented out and not in use. Keep your code as clean as possible.
...
void Entity::update(Game* game, float elapsed)
{
	...
	// <FEEDBACK> This should be part of the Collider Component. You should call collider->update() instead.
	// But Entity should not have a collider component, so this should happen in the subclasses update methods.
...
void Entity::draw(Window* window)
{
	...
	// <FEEDBACK> This should be part of the collider component.
